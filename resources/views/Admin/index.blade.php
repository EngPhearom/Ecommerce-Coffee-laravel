...
<body>
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    <a href="{{ route('login') }}" class="btn btn-outline-info mx-3 mt-2 d-block">Login</a>
                    <a href="{{ route('singup') }}" class="btn btn-outline-success mx-3 mt-2 d-block">Register</a>
  ...
  <script src="{{ asset('https://cdn.jsdelivr.net/npm/gasparesganga-jquery-loading-overlay@2.1.7/dist/loadingoverlay.min.js') }}"></script>
